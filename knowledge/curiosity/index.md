...
(Updated 2026-06-28 — Self-Assessment: keywords expanded, Wayfinder HN #10, workweave/router deceased)
...
| **workweave/router** | 327★ Go proxy — routes prompts to best model in <50ms. Supports DeepSeek, GLM, Qwen via OpenRouter. **CONFIRMED NON-EXISTENT 2026-06-28** — 0 repos at any known URL. Removed from active backlog. | Medium | **CONFIRMED NON-EXISTENT** |
...
||| **Wayfinder Router** | 206★ PyPI — deterministic prompt-complexity routing (no model call, sub-ms, offline). Composes with OpenRouter/Bifrost/LiteLLM gateways. 101 HN pts. +44% growth in 12h. | Medium | **ACTIVE — Evaluate as integration component** ||
|| **bikini 0-day dump** | 835pts HN — account mass-dropping purported 0-days. Community dismisses as low-quality (code-execution→code-execution). | Low | **Reviewed 2026-06-28 — not a threat** |
...
|| 2026-06-28 | **Curiosity Web Monitor — Keywords Expanded** — Added 10 new AI keywords (mythos, sol, glm, deepseek, fugu, wayfinder, workweave, router, orca, montage, mcp) to HN story filter. Synced all 3 tiers. | Better intel coverage — catches GLM, DeepSeek, Fugu, Orca, and MCP ecosystem developments. |
...
4. **Workweave Router** (~~327★, ELv2 — **CONFIRMED NON-EXISTENT 2026-06-28** — 0 GitHub repos, removed from pipeline) — Multi-provider model router. Was referenced with <50ms routing but the project does not exist at any known URL. Removed from active research.
