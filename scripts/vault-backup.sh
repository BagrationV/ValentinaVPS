...
cp "$HOME/.hermes/profiles/valentina/SOUL.md" "$VAULT_DIR/" 2>/dev/null || true
cp "$HOME/.hermes/profiles/valentina/DREAM.md" "$VAULT_DIR/" 2>/dev/null || true

# Backup core protocols
cp "$HOME/.hermes/profiles/valentina/skills/valentina-core/"*.md "$VAULT_DIR/" 2>/dev/null || true
